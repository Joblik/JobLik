...
import GlobalStyles from "./globalStyles";
  ...
  style={[
    ...
    styles.homeChildLayout2,
    styles.homeChild3Position,
  ]}
  resizeMode="cover"
  source={require("./rectangle-9.png")}
/>
<Text
  style={[
    styles.usernameTypo1,
    styles.usernameTypo2,
...
{/* user image */}
<Image
  style={[styles.iconLayout, styles.usernamePosition]}
  resizeMode="cover"
  source={require("./image-5.png")}
/>
<Text style={[styles.title, styles.titleTypo1]}>Title</Text>
<Text style={[styles.description, styles.titleTypo1]}>Description</Text>
</View>  )
}
